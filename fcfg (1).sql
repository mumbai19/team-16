...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 21, 2019 at 01:45 AM
...
--
-- Table structure for table `datamin`
--

CREATE TABLE `datamin` (
  `fid` int(11) NOT NULL,
...
--
-- Table structure for table `farmerassets`
--

CREATE TABLE `farmerassets` (
  `aid` int(11) NOT NULL,
  `id` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `farmerassets`
--

INSERT INTO `farmerassets` (`aid`, `id`, `product_name`, `product_description`, `price`, `stock`, `weight`, `date`) VALUES
(1, 1, 'fish', 'fish', 1, 1, 1, '2019/07/21'),
(2, 1, 'fish 2', 'temperory', 1, 1, 1, '2019/07/21'),
(3, 1, 'abc', 'abc', 10, 10, 10, '9/12/19');
...
--
-- Table structure for table `vendorassets`
--
...
--
-- Indexes for table `farmerassets`
--
ALTER TABLE `farmerassets`
  ADD PRIMARY KEY (`aid`),
  ADD KEY `id` (`id`);
...
--
-- Indexes for table `vendorassets`
--
ALTER TABLE `vendorassets`
  ADD PRIMARY KEY (`aid`),
  ADD KEY `id` (`id`);
...
--
-- AUTO_INCREMENT for table `datamin`
--
ALTER TABLE `datamin`
...
--
-- AUTO_INCREMENT for table `farmerassets`
--
ALTER TABLE `farmerassets`
...
--
-- AUTO_INCREMENT for table `vendorassets`
--
ALTER TABLE `vendorassets`
...
--
-- Constraints for table `datamin`
--
ALTER TABLE `datamin`
  ADD CONSTRAINT `datamin_ibfk_1` FOREIGN KEY (`id`) REFERENCES `users` (`id`);
...
--
-- Constraints for table `farmerassets`
--
ALTER TABLE `farmerassets`
  ADD CONSTRAINT `farmerassets_ibfk_1` FOREIGN KEY (`id`) REFERENCES `users` (`id`);
...
--
-- Constraints for table `vendorassets`
--
ALTER TABLE `vendorassets`
  ADD CONSTRAINT `vendorassets_ibfk_1` FOREIGN KEY (`id`) REFERENCES `users` (`id`);
COMMIT;
