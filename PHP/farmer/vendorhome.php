...
<html lang="en">
  ...
  <body>
    ...
    <section class="home-slider owl-carousel">
      <div class="slider-item" style="background-image:url(images/f1.jpg);">
      	<div class="overlay"></div>
        <div class="container">
          <div class="row no-gutters slider-text align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 ftco-animate">
            <h1 class="mb-4">Jaljeevika’s mission is the promotion of aquatic based livelihood and protection of aquatic ecology.</p>
      ...
      <div class="slider-item" style="background-image:url(images/f2.jpg);">
      	<div class="overlay"></div>
        <div class="container">
          <div class="row no-gutters slider-text align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-6 ftco-animate">
            <h1 class="mb-4">We at Jaljeevika work towards promotion of aquatic livelihood.</p>
            <p><a href="#" class="btn btn-primary px-4 py-3 mt-3">Contact Us</a></p>
          </div>
        </div>
        </div>
    ...
    <div class="col-sm-4 col-xs-12 ff">
      <div class="panel panel-default text-center">
        ...
        <div class="panel-footer">
          ...
          <button class="btn btn-lg btn-secondary">Sign Up</button>
        </div>
      </div>      
    </div>     
    <div class="col-sm-4 col-xs-12 ff" >
            ...
            <div class="ftco-footer-widget mb-5">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                ...
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">jaljeevika@gmail.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
