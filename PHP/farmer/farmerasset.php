            ...
            <div class="card card-5">
                ...
                <div class="card-body">
                    <form method="POST">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="asset_name">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <div class="name">Price per Asset</div>
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="number" name="cpass">
                                </div>
                            </div>
                        </div>
                       
                        <div>
                            <button class="btn btn--radius-2 btn--red text-center" type="submit" >Add</button>
                        </div>
                    </form>
                </div>
            </div>
